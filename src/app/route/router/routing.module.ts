...
import { AuthGuard, ProfileGuard, OAuthGuard } from '@route/routing.guard';
...
const routes: Routes = [
	...
	{ path: 'login', component: LoginComponent, canActivate: [OAuthGuard] },
	{ path: 'attend', component: AttendComponent, canActivate: [AuthGuard, ProfileGuard, OAuthGuard] },
