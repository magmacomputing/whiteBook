import type { COLLECTION, STORE, FIELD, CLASS, EVENT, CONNECT, BONUS, REACT, Auth, PLAN, PRICE, PAYMENT, PROFILE, STATUS, SCHEDULE, MESSAGE, SPAN, COLOR, Zoom, TRACK } from '@dbase/data/data.define';
...
type TStoreMember = STORE.profile | STORE.payment | STORE.gift | STORE.message | STORE.attend | STORE.status | STORE.migrate;
...
interface MemberCollection extends UserField {			// this is the base for Member-related documents
	[FIELD.store]: TStoreMember;
	[FIELD.stamp]: number;
}
interface ForumCollection extends KeyField, UserField {
...
export type TStoreBase = ClientCollection | UserField;
...
//	/member/gift
export interface Gift extends MemberCollection {
...
export interface Migrate extends MemberCollection, KeyField {	// these allow for reconciliation of migrated event
