...
type TStoreAdmin = STORE.register | STORE.migrate
 ...
 */
interface AdminBase extends BaseDocument {
...
export type TStoreBase = AdminBase | ClientBase | MemberBase | Forum | Migrate;
...
//	/client/plan
export interface Plan extends Omit<ClientBase, FIELD.type> {
	[FIELD.store]: STORE.price;
	[FIELD.key]: PLAN;
	[FIELD.sort]: number;
...
export interface Register extends AdminBase {
